...
Hub: [Factory hub](FACTORY.md). Make map: [SPARKBC_MAKE.md](SPARKBC_MAKE.md). Diagrams: [Diagrams](DIAGRAMS.md).
...
[Methods vs OpenBin](METHODS_OPENBIN.md).
...
- Eval / train proofs remain measurement-only (see [Eval](EVAL.md)).
